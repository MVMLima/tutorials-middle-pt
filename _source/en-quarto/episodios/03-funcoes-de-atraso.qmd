...
- Complete tutorial [Access epidemiological delay distributions](01-acessar-atrasos.qmd)
...
![The four probability functions for the normal distribution ([Jack Weiss, 2012](https://web.archive.org/web/20240210121034/https://sakai.unc.edu/access/content/group/3d1eb92e-7848-4f55-90c3-7c72a54e7e43/public/docs/lectures/lecture13.htm#probfunc))](../img/fig5a-normaldistribution.png)
...
For a refresher, you can read the tutorial [Glossary](../glossario.qmd).
...
![**Timeline for chain of disease reporting, the Netherlands.** Lab, laboratory; PHA, public health authority. From [Marinović et al., 2015](https://wwwnc.cdc.gov/eid/article/21/2/13-0504_article)](../img/disease-reporting.jpg)

The **delay distribution** could be inferred jointly with the underlying times of infection or estimated as the sum of the [incubation period](../glossario.qmd#incubation) distribution and the distribution of delays from symptom onset to observation from line list data ([reporting delay](../glossario.qmd#reportingdelay)). For `{EpiNow2}`, we can specify these two complementary delay distributions in the `delays` argument.

![**$R_{t}$ is a measure of transmission at time $t$.** Observations after time $t$ must be adjusted. ICU, intensive care unit. From  [Gostic et al., 2020](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1008409#sec007)](../img/rt-adjusting-delays.png)
